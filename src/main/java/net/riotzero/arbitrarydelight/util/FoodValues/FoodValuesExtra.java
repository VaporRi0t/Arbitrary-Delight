...
public class FoodValuesExtra {
    ...
    public static final FoodProperties CHERRY_BLOSSOM_TEA =
            (new FoodProperties.Builder()).alwaysEat().effect(() -> new MobEffectInstance(MobEffects.DIG_SPEED, 1200, 0), 1.0F).build();
