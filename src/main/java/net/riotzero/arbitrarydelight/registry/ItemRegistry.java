...
public static final DeferredItem<Item> GLISTERING_MELON_JUICE = ITEMS.register("glistering_melon_juice",
    ...
    public static final DeferredItem<Item> CHEESE_PIZZA_SLICE = ITEMS.register("cheese_pizza_slice",
            () -> new Item(foodItem(FoodValues.PIE_SLICE)));
    public static final DeferredItem<Item> VEGGIE_PIZZA = ITEMS.register("veggie_pizza",
            () -> new BlockItem(BlockRegistry.VEGGIE_PIZZA.get(), basicItem()));
    public static final DeferredItem<Item> VEGGIE_PIZZA_SLICE = ITEMS.register("veggie_pizza_slice",
            () -> new Item(foodItem(FoodValues.PIE_SLICE)));
    public static final DeferredItem<Item> SUPREME_PIZZA = ITEMS.register("supreme_pizza",
            () -> new BlockItem(BlockRegistry.SUPREME_PIZZA.get(), basicItem()));
    public static final DeferredItem<Item> SUPREME_PIZZA_SLICE = ITEMS.register("supreme_pizza_slice",
            () -> new Item(foodItem(FoodValues.PIE_SLICE)));
